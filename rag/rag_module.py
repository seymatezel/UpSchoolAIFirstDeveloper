# rag/rag_module.py (GÜNCELLENMİŞ)
...
@st.cache_data(show_spinner=False)  # <- 2. EKLENEN SATIR (show_spinner=False ekledik)
def create_rag_chain(document_input, api_key: str):
    """
    Yüklenen bir PDF dosyasını VEYA doğrudan metni alır, işler ve 
    bir soru-cevap (RAG) zinciri oluşturur. Bu fonksiyon önbelleğe alınmıştır.
    """
